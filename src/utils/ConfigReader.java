...
public class ConfigReader
{
	...
	public static final String ADENOMAS_WEKA_DIR = "ADENOMAS_WEKA_DIR";
	...
	public static String getAdenomasWekaDir() throws Exception
	{
		return getConfigReader().getAProperty(ADENOMAS_WEKA_DIR);
	}
